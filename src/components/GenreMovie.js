  ...
  return (
    <div className='genre-part'>
            ...
            <div className='genre-part-list'>
              {movieGenreList?.results.filter(({genre_ids}) => genre_ids.includes(18)).map((item)=><Comedy item={item}></Comedy>)}
            </div>
            ...
            <div className='genre-part-list'>
              {movieGenreList?.results.filter(({genre_ids}) => genre_ids.includes(53)).map((item)=><Comedy item={item}></Comedy>)}
            </div>
